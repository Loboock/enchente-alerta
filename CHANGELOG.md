...
### Adicionado
- Criação do repositório do projeto EnchenteAlerta.
- README.md com informações do projeto, integrantes, turma e responsabilidades.
- Análise inicial do estudo de caso (docs/estudo-de-caso.md).
